        ...
        <div class="card o-hidden border-0 shadow-lg my-5 col-md-9">
            <div class="card-body ">
                ...
                <div class="p-2">
                    ...
                    <form class="form needs-validation " action="<?=old('role','user')?>/operations.php" method="post" enctype="multipart/form-data" novalidate>
                        <?php
                        ...
                        <div class="form-group ">
                            <div class="custom-file col-md-12">
                                    ...
                                    <label class="custom-file-label" for="formFile" id="formFileLabel" data-browse="تصفح">  اختيار ملف</label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="password" class="form-control form-control-user"
                                       id="newPassword" placeholder="كلمة المرور" name="password"  value="<?=old('password')?>" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="password" class="form-control form-control-user"
                                       id="confirmPassword" placeholder="تأكيد كلمة المرور" value="<?=old('password')?>" required>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <select class="custom-select" name="role" id="role" required>
                                    <option selected disabled value="" >حساب</option>
                                    <option value="user">مستخدم</option>
                                    <option value="technician">فني</option>
                                </select>
                                <div class="invalid-feedback">
                                    يجب عليك القيام بتحديد نوع حسابك
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    (function () {
        ...
        $('#role').on('change',function(){
            $(".needs-validation").attr('action',$(this).val()+'/operations.php')
        })
    })()
</script>
