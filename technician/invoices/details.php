...
if (isset($_GET['id'])) {
    ...
    $tech=(new DB('technicians'))->getBy('id',$_SESSION['id']);
    $item = (new DB('invoices i'))
        ->join('orders o', 'i.order_id=o.id')
        ->join('users u', 'o.user_id = u.id')
        ->join('devices d', 'o.device_id = d.id')
        ->select("i.*,o.description,d.name,d.location,CONCAT(u.first_name, ' ',u.last_name) as full_name")
        ->where("i.id", $_GET['id'])
        ->getOne();
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            ...
                            <div class="col-md-3 col-sm-12  ">
                                <div class="mb-5">
                                    ...
                                    <p class="text-bold-800"> <?= $tech['first_name'].' '.$tech['last_name'] ?></p>
                                    <p class="text-bold-800"> <?= $tech['address'] ?></p>
                                </div>
