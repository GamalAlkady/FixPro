                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="form needs-validation" action="<?=old('role','user')?>/operations.php" method="post" novalidate>
                                    ...
                                    <div class="form-group">
                                           <select class="form-control" name="role" id="role">
                                               <option style="background-color: #d7dfeb" disabled>دخول ك</option>
                                               <option value="user" <?=(old('role','selected')=='user' or old('role','selected')=='selected')?'selected':''?> >مستخدم</option>
...
<!--                                </div>-->
                                <div class="text-center">
                                    <a class="small" href="register.php">انشاء حساب</a>
                                </div>
                            </div>
                        </div>
                    </div>
